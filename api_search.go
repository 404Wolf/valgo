...
type ApiSearchValsRequest struct {
	ctx context.Context
...
func (r ApiSearchValsRequest) Offset(offset int32) ApiSearchValsRequest {
	r.offset = &offset
	return r
}

// Maximum items to return in each paginated response
func (r ApiSearchValsRequest) Limit(limit int32) ApiSearchValsRequest {
	r.limit = &limit
	return r
}

// Search query
func (r ApiSearchValsRequest) Query(query string) ApiSearchValsRequest {
	r.query = &query
	return r
}

func (r ApiSearchValsRequest) Execute() (*SearchVals200Response, *http.Response, error) {
	return r.ApiService.SearchValsExecute(r)
}

/*
SearchVals Method for SearchVals

Search for vals across the platform

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSearchValsRequest
*/
func (a *SearchAPIService) SearchVals(ctx context.Context) ApiSearchValsRequest {
	return ApiSearchValsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SearchAPIService) SearchValsExecute(r ApiSearchValsRequest) (*SearchVals200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SearchAPIService.SearchVals")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/search/vals"
